...
export const BACKGROUND_IMAGE = `${BASE}bg/battlefield_v3.webp`;
...
// battlefield_v3.webp 원본 크기(847x1857, 기존과 같은 688:1508 비율)에서
// 실측한 좌표를 %로 변환한 값.
...
export const STAGE_LAYOUT = {
  // battlefield_v3.webp의 검은 외곽선 안쪽 실제 전투면을 다시 실측한 값.
